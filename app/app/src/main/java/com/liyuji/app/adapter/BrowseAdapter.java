...
public class BrowseAdapter extends BaseAdapter {
    ...
    public BrowseAdapter(LayoutInflater mInflater, List<BrowseVO> browseVOList) {
        this.mInflater = mInflater;
        this.browseVOList = browseVOList;
    }

    @Override
    public int getCount() {
        return browseVOList.size();
    }

    @Override
    public Object getItem(int position) {
        return browseVOList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        BrowseVO browseVO = (BrowseVO) getItem(position);
        View view = mInflater.inflate(R.layout.listitem_browse, null);
        ...
        TextView mBrowseTime = view.findViewById(R.id.browse_time);
        ...
        mBrowseTime.setText(browseTime);
